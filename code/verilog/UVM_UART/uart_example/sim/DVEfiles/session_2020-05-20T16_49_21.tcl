...
# DVE full session
# Saved on Wed May 20 16:39:02 2020
# Designs open: 1
...
# DVE version: I-2014.03-SP1-7
# DVE build date: Apr  9 2015 20:59:07


#<Session mode="Full" path="/dataA/ftk-yt/parkershe/UVM/uart_example/sim/DVEfiles/session.tcl" type="Coverage">
...
gui_show_window -window ${CovTopLevel.1} -show_state normal -rect {{238 229} {1528 1031}}
...
gui_update_layout -id ${CovHier.1} {{left 0} {top 0} {width 199} {height 519} {dock_state left} {dock_on_new_line true} {child_covhier_colhier 140} {child_covhier_coltype 100} {child_covhier_col1 1} {child_covhier_col2 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1290} {height 179} {dock_state bottom} {dock_on_new_line true}}
...
gui_open_cov  -hier {merge_simv.vdb}   -testdir {merge_simv.vdb} -autoopen False  -test { {merge_simv/test} } -merge {MergedTest}
...
catch {gui_list_expand -id ${CovHier.1} uart_tb}
catch {gui_list_expand -id ${CovHier.1} uart_tb.DUT}
catch {gui_list_expand -id ${CovHier.1} uart_tb}
catch {gui_list_expand -id ${CovHier.1} uart_tb.DUT}
catch {gui_list_expand -id ${CovHier.1} uart_tb.DUT}
catch {gui_list_select -id ${CovHier.1} {uart_tb.DUT}}
gui_covtable_show -id CoverageTable.1 -show {Design Hierarchy}  -cumulative 1
catch {gui_list_expand -id ${CoverageTable.1} uart_tb}
catch {gui_list_expand -id ${CoverageTable.1} uart_tb.DUT}
catch {gui_list_expand -id ${CoverageTable.1} uart_tb.DUT}
catch {gui_list_select -id ${CoverageTable.1} {uart_tb.DUT}}

# Source 'CovDetail.1'
gui_src_value_annotate -id ${CovDetail.1} -switch false
gui_set_env TOGGLE::VALUEANNOTATE 0
gui_open_source -id ${CovDetail.1}  -matrix Line -replace -active uart_tb.DUT -type {Scope}  /dataA/ftk-yt/parkershe/UVM/uart_example/sim/../rtl/uart/uart_16550.sv
gui_src_value_annotate -id ${CovDetail.1} -switch true
gui_set_env TOGGLE::VALUEANNOTATE 1
gui_view_scroll -id ${CovDetail.1} -vertical -set 448
...
gui_covdetail_select -id CovDetail.1 -region {uart_tb.DUT} -type {Instance}
