...
# DVE full session
# Saved on Wed May 20 15:55:09 2020
# Designs open: 1
...
gui_show_window -window ${CovTopLevel.1} -show_state normal -rect {{230 228} {1521 1031}}
...
gui_update_layout -id ${CovHier.1} {{left 0} {top 0} {width 199} {height 520} {dock_state left} {dock_on_new_line true} {child_covhier_colhier 140} {child_covhier_coltype 100} {child_covhier_col1 1} {child_covhier_col2 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1291} {height 179} {dock_state bottom} {dock_on_new_line true}}
...
gui_open_cov  -hier {parker.vdb}   -testdir {parker.vdb} -autoopen False  -test { {parker/test} } -merge {MergedTest}
